...
## Project Structure
- `app.py`: Main entry point for the Flask application. Handles API routes and ensures that dependency injection is configured and the database is created and seeded on startup.
...
- `donfiguration/`: Contains a simple `AppConfig` class which holds the application's configuration.
